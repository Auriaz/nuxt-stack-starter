...
<template>
  ...
  >
    <div class="max-w-2xl w-full text-center space-y-8">
      <!-- Error Code -->
      <div class="space-y-4">
        <div v-if="props.error.statusCode" class="inline-block">
          <h1
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
        <UButton color="primary" size="lg" icon="i-heroicons-home" @click="handleError">
          Powrót do strony głównej
        </UButton>
        <UButton variant="outline" size="lg" icon="i-heroicons-arrow-path" @click="handleError">
          Odśwież stronę
        </UButton>
      </div>
