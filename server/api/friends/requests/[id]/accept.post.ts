...
import { acceptFriendRequestUseCase } from '~~/domain/friends/acceptFriendRequest.usecase'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    const request = await acceptFriendRequestUseCase(id, userId, friendsRepository)
