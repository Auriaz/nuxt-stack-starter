...
import { listTeamThreadsUseCase } from '~~/domain/chat/listTeamThreads.usecase'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    const threads = await listTeamThreadsUseCase(userId, teamId, permissions, teamsRepository, chatRepository)
    return {
