...
import { declineTeamInviteUseCase } from '~~/domain/teams/declineTeamInvite.usecase'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    const result = await declineTeamInviteUseCase(inviteId, userId, teamsRepository)
    ...
    if (result.changed) {
      ...
      await createNotification({
        ...
        message: `${inviteeName} odrzucil(a) zaproszenie do zespolu ${teamLabel}.`,
